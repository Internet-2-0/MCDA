...
namespace MCDA_APP.Controls
{
    ...
    public abstract class TabStyleProvider : Component
    {
        ...
        protected CustomTabControl TabControl { get; private set; }
        ...
        public Point Padding
        {
            ...
            set
            {
                ...
                {
                    if (value.X + (int)(this._Radius / 2) < -CustomTabControl.TabCloserButtonSize)
                    {
                        ((System.Windows.Forms.TabControl)this.TabControl).Padding = new Point(0, value.Y);
                    }
                    else
                    {
                        ((System.Windows.Forms.TabControl)this.TabControl).Padding = new Point(value.X + this._Radius + (int)(CustomTabControl.TabCloserButtonSize + 10) / 2, value.Y);
                    }
                }
                else
                {
                    ...
                    {
                        ((System.Windows.Forms.TabControl)this.TabControl).Padding = new Point(value.X + this._Radius, value.Y);
                    }
                }
            }
        }
        ...
        public bool HotTrack
        {
            ...
            set
            {
                ...
                ((System.Windows.Forms.TabControl)this.TabControl).HotTrack = value;
            }
        }
