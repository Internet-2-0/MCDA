    ...
    public abstract class Engine : IEngine
    {
        ...
        private string ElementMatchHandler(Definition definition, Match match)
        {
            ...
            if (pattern != null)
            {
                ...
                if (pattern is RegexPattern)
                {
                    return ProcessRegexPatternMatch(definition, (RegexPattern)pattern, match);
                }
        ...
        protected abstract string ProcessRegexPatternMatch(Definition definition, RegexPattern pattern, Match match);
